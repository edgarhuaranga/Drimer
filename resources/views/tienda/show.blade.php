            ...
            <div class="row">
                <div class="col-md-6 d-md-flex align-items-md-center">
                    <div class="py-4 py-md-0 text-center text-md-left invisible" data-toggle="appear">
                        <h1 class="font-size-h2 mb-2">{{$tienda->nombre_sede.'-'.$tienda->cadena()->nombre}}</h1>
                        ...
                        <div class="content">
                            ...
                            <div id="side-content" class="d-none d-md-block push">
                              ...
                              <form action="/tiendas" method="POST">
                                {{csrf_field()}}
                                <h2 class="content-heading pt-0">Actualizar tienda</h2>
                                <div class="row push">
                                    ...
                                    <div class="col-lg-8 col-xl-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nombre_sede" name="nombre_sede" value="{{$tienda->nombre_sede}}">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="ubigeo" name="ubigeo" value="{{$tienda->ubigeo}}">
                                        </div>
                          ...
                          <div class="row">
                              <div class="col-md-6 col-xl-3 js-appear-enabled animated fadeIn" data-toggle="appear">
                                <a class="block block-rounded block-link-pop text-center" href="javascript:void(0)">
                                    <div class="block-content block-content-full aspect-ratio-16-9 d-flex justify-content-center align-items-center">
                                        <div>
                                            <div class="font-size-h1 font-w300 text-black">{{$tienda->resumen()['q_hoy']}}</div>
                                            <div class="font-size-h3 font-w300 text-black">S/.{{$tienda->resumen()['monto_hoy']}}</div>
                              ...
                              <div class="col-md-6 col-xl-3 js-appear-enabled animated fadeIn" data-toggle="appear">
                                <a class="block block-rounded block-link-pop text-center" href="javascript:void(0)">
                                    <div class="block-content block-content-full aspect-ratio-16-9 d-flex justify-content-center align-items-center">
                                        <div>
                                            <div class="font-size-h1 font-w300 text-black">{{$tienda->resumen()['q_ayer']}}</div>
                                            <div class="font-size-h3 font-w300 text-black">S/.{{$tienda->resumen()['monto_ayer']}}</div>
                              ...
                              <div class="col-md-6 col-xl-3 js-appear-enabled animated fadeIn" data-toggle="appear">
                                <a class="block block-rounded block-link-pop text-center" href="javascript:void(0)">
                                    <div class="block-content block-content-full aspect-ratio-16-9 d-flex justify-content-center align-items-center">
                                        <div>
                                            <div class="font-size-h1 font-w300 text-black">{{$tienda->resumen()['q_semana']}}</div>
                                            <div class="font-size-h3 font-w300 text-black">S/.{{$tienda->resumen()['monto_semana']}}</div>
                              ...
                              <div class="col-md-6 col-xl-3 js-appear-enabled animated fadeIn" data-toggle="appear">
                                <a class="block block-rounded block-link-pop text-center" href="javascript:void(0)">
                                    <div class="block-content block-content-full aspect-ratio-16-9 d-flex justify-content-center align-items-center">
                                        <div>
                                            <div class="font-size-h1 font-w300 text-black">{{$tienda->resumen()['q_mes']}}</div>
                                            <div class="font-size-h3 font-w300 text-black">S/.{{$tienda->resumen()['monto_mes']}}</div>
