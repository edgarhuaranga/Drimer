              ...
              <div class="row push">
                <div class="col-lg-8 col-xl-12">
                  <div class="form-group">
                    <label for="text-input-name">Codigo</label>
                  ...
                  <div class="form-group">
                    <label for="text-input-address">Presentacion</label>
                ...
                <!-- DataTables init on table by adding .js-dataTable-buttons class, functionality is initialized in js/pages/be_tables_datatables.min.js which was auto compiled from _es6/pages/be_tables_datatables.js -->
                  <table class="table table-bordered table-striped table-vcenter js-dataTable-buttons">
                    ...
                    <tr>
                      ...
                      <th>Segmento x Formula</th>
                      <th>Segmento x Marca</th>
                      <th>Categoria</th>
                      <th>Marca</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td class="font-w600">
                          <a href="/products/{{$product->id}}">{{$product->codigo}}</a>
                        </td>
                        <td class="d-none d-sm-table-cell">
                          {{$product->segmento_x_formula}}
                        </td>
                        <td class="d-none d-sm-table-cell">
                          {{$product->segmento_x_marca}}
                        </td>
                        <td class="d-none d-sm-table-cell">
                          {{$product->categoria}}
                        </td>
